...
import { deleteProduct } from "../../pages/products/deleteProduct.page.js"
...
productRouter.put("/update/:id", adminMiddleware, updateProduct)        // PUT /products/update/:id
productRouter.delete("/delete/:id",adminMiddleware, deleteProduct)      // DELETE / products/delete/:id
